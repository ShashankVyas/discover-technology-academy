...
const credentialData = {
	"firstName": "Sundar",
    "lastName": "S",
    "emailId": "sundar.S@abc.com",
    "BankName": "Discover",
    "acctLastFour": "4445",
    "routingNbr": "031100649"
};
...
//const serviceAccount = require('./firebase-sa-config.json');
		...
		case 'did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/issue-credential/1.0/sent':
			if (message.msg['credentials~attach']) {
				...
				/*const pushText = {
					notification: {
						title: 'Hi Sundar',
						body: 'testing our app'
					},
					registrationToken: ""
				}

				admin.messaging().sendToDevice(registrationToken, pushText, options)
				.then( response => {
